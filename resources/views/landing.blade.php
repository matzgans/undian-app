<x-landing-layout>
    <div class="relative w-full h-96 p-2 bg-black" id="controls-carousel" data-carousel="static">
        <!-- Carousel wrapper -->
        <div class="relative h-full overflow-hidden rounded-lg">
            <!-- Item 1 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img class="absolute left-1/2 top-1/2 block max-w-full max-h-full -translate-x-1/2 -translate-y-1/2"
        ...
        <!-- Slider controls -->
        <button
            class="group absolute start-0 top-1/2 z-30 flex h-10 w-10 cursor-pointer items-center justify-center px-4 -translate-y-1/2 focus:outline-none"
        ...
        <button
            class="group absolute end-0 top-1/2 z-30 flex h-10 w-10 cursor-pointer items-center justify-center px-4 -translate-y-1/2 focus:outline-none"
    ...
    <form class="mx-auto max-w-full p-5" action="{{ route('participant.store') }}" method="POST"
        ...
        <div class="mb-5">
            ...
            <input
                class="focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:outline-none"
                id="ktp_id" name="ktp_id" type="text" placeholder="Nomor KTP" required pattern="\d{16}"
        ...
        <button
            class="mb-5 block w-full cursor-pointer rounded-lg border border-amber-300 bg-amber-50 text-sm text-amber-900 focus:outline-none dark:border-amber-600 dark:bg-amber-700 dark:text-amber-400 dark:placeholder-amber-400 p-5"
