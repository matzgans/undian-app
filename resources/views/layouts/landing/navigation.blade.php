    ...
    <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        ...
        <div class="flex space-x-3 rtl:space-x-reverse md:order-2 md:space-x-0">
            @if (Route::currentRouteName() == 'tickets.show')
                <a class="rounded-lg bg-white px-4 py-2 text-center text-sm font-medium text-orange-700 hover:bg-slate-400 focus:outline-none focus:ring-4 focus:ring-white dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-white"
